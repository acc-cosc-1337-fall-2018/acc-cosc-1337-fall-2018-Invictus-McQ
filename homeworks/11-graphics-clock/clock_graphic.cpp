...
{
	double hours_angle = clock.get_hours() / 12.0 * 360.0 + clock.get_minutes() / 3600.0 * 360.0;
...
{
	double minutes_angle = clock.get_minutes() / 60.0 * 360.0 + clock.get_seconds() / 3600.0 * 360.0;
